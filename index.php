...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=' . $channelId . '&key=AIzaSyBCJPWz0ah8kiIS5orm3iY3RjSTUR2QsEQ');
...
// latest video
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyBCJPWz0ah8kiIS5orm3iY3RjSTUR2QsEQ&channelId=' . $channelId . '&maxResults=1&order=date&part=snippet';
$result = get_CURL($urlLatestVideo);
$latestVideoId = $result['items'][0]['id']['videoId'];

// Instagram API
// $clientId = 'f0b022fbe68c4ae79dd51169af18feb4';
// $accessToken = 'IGQVJWWVRKTGwzUmJKaWRNNlRYZAmMzY3puSUVRSEppU1ozdVowTWU5ZAmFYRjNmR2ZAVWEpqLWotTGdZAT2NuZA2I2eUs5WHdINFMyT3VIUXJUTi0tQnZAVNmp4VDVoNTlpTkhKS01xbEExQ0xOaEFoaFdmMwZDZD';
